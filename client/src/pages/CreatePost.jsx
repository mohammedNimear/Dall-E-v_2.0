...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      focus:ring-blue-500 focus:border-blue-500 p-3 w-64
      h-64 flex justify-center items-center "
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">Once you create your image you want, you can share it with the community</p>
          <button
            className="mt-2 text-white bg-[#6469ff] font-medium
